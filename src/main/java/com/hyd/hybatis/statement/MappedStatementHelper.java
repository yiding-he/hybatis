...
public class MappedStatementHelper {
    ...
    public static MappedStatement buildMappedStatement(
            Configuration configuration, String sqlId, Class<?> mapperType, SqlSource sqlSource, SqlCommandType commandType
    ) {
        return buildMappedStatement(configuration, sqlId, mapperType, null, sqlSource, commandType);
    }
     ...
     */
    public static MappedStatement buildMappedStatement(
            Configuration configuration, String sqlId,
            Class<?> mapperType, Class<?> entityType,
        ...
        if (resultMap == null && entityType != null) {

            // var resultMappings = new ArrayList<ResultMapping>();
            // String resource = mapperType.getName().replace('.', '/') + ".java (best guess)";
            ...
            // assistant.addResultMap(sqlId, entityType, null, null, resultMappings, true);
